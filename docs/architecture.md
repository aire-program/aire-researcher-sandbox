...
- **notebooks/**: Jupyter notebooks for text, tabular, RAG, and prototype workflows. Each notebook includes a Colab-friendly setup cell and runs against local synthetic data.
- **pipelines/**: Python modules for text processing, embeddings, and other reusable logic.
